...
require_once SRC_DIR . '/helpers/functions.php';

// Verificar se o usuário já está logado
if (isset($_SESSION['user_id'])) {
    // Redirecionar com base no nível do usuário
    if ($_SESSION['user_nivel'] === 'tecnico' || $_SESSION['user_nivel'] === 'tecnico_adm') {
        header('Location: /simaorefrigeracao/tecnico/dashboard');
    } else {
        header('Location: /simaorefrigeracao/admin/dashboard');
    }
    exit;
}
...
if (isset($_GET['logout'])) {
    ...
    if ($nivel === 'tecnico' || $nivel === 'tecnico_adm') {
        header('Location: /simaorefrigeracao/admin-login.php?tecnico=1');
    } else {
        header('Location: /simaorefrigeracao/admin-login.php');
    }
    exit;
}
    ...
    <div class="login-container">
        ...
        <div class="login-form">
            ...
            <div class="login-toggle">
                <?php if ($is_tecnico): ?>
                    <a href="/simaorefrigeracao/admin-login.php">Acessar como Administrador</a>
                <?php else: ?>
                    <a href="/simaorefrigeracao/admin-login.php?tecnico=1">Acessar como Técnico</a>
                <?php endif; ?>
            </div>
            
            <div class="text-center mt-3">
                <a href="/simaorefrigeracao/" class="back-to-site">
