       ...
       document.addEventListener('DOMContentLoaded', function() {
           ...
           var calendar = new FullCalendar.Calendar(calendarEl, {
               ...
               eventClick: function(info) {
                   ...
                   // Garantir que o botão "Ver Detalhes" funcione corretamente
                   $('#view-event').off('click').on('click', function(e) {
                       e.preventDefault();
                       window.location.href = 'tecnico-agendamento.php?id=' + info.event.id;
                   });
           ...
           $('#userDropdown').on('click', function(e) {
               e.stopPropagation();
               $('#userDropdownMenu').css('display', 'block').toggleClass('show');
           });
