...
// Fix the statistics queries to ensure they correctly count records from the database

// Replace the statistics retrieval code with this improved version:
try {
   // Contar clientes
   ...
   // Fix the depoimentos count retrieval
...
// Fix the servicos_populares query to use the correct column name
try {
   $query = "SELECT 
           s.titulo as servico,
           COUNT(a.id) as total
