...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 26, 2025 at 03:17 AM
...
--
CREATE DATABASE IF NOT EXISTS `simaorefrigeracao` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `simaorefrigeracao`;
...
INSERT INTO `agendamentos` (`id`, `titulo`, `cliente_id`, `servico_id`, `tecnico_id`, `data_agendamento`, `hora_inicio`, `hora_fim`, `observacoes`, `status`, `data_criacao`, `data_atualizacao`) VALUES
(1, 'Instalação de Ar Split', 3, 1, 1, '2025-04-23', '09:00:00', '11:00:00', NULL, 'pendente', '2025-04-23 22:07:04', NULL),
(2, 'Manutenção Preventiva', 1, 2, 2, '2025-04-23', '14:00:00', '16:00:00', NULL, 'pendente', '2025-04-23 22:07:04', NULL),
(3, 'Instalação de Câmara Fria', 4, 5, 3, '2025-04-25', '08:00:00', '17:00:00', NULL, 'pendente', '2025-04-23 22:07:04', NULL),
(4, 'Manutenção Corretiva', 2, 3, 2, '2025-04-24', '10:00:00', '12:00:00', NULL, 'pendente', '2025-04-23 22:07:04', NULL),
(5, 'Instalação de Ar Condicionado', 1, 1, 1, '2025-04-25', '10:00:00', '12:00:00', 'Cliente solicitou instalação com urgência', 'pendente', '0000-00-00 00:00:00', NULL);
...
INSERT INTO `servicos` (`id`, `titulo`, `icone`, `descricao`, `itens`, `data_criacao`, `data_atualizacao`) VALUES
(1, 'Instalação de Ar Condicionado', 'fan', 'Instalação profissional de equipamentos residenciais e comerciais.', '[\"Instalação de splits e multi-splits\", \"Instalação de ar condicionado central\", \"Instalação de VRF/VRV\"]', '2025-04-23 22:07:03', NULL),
(2, 'Manutenção Preventiva', 'thermometer', 'Serviços regulares para garantir o funcionamento ideal do seu equipamento.', '[\"Limpeza de filtros e componentes\", \"Verificação de gás refrigerante\", \"Inspeção de componentes elétricos\"]', '2025-04-23 22:07:03', NULL),
(3, 'Manutenção Corretiva', 'tools', 'Reparo rápido e eficiente para resolver problemas no seu equipamento.', '[\"Diagnóstico preciso de falhas\", \"Reparo de vazamentos\", \"Substituição de componentes\"]', '2025-04-23 22:07:03', NULL),
(4, 'Visita Técnica', 'phone', 'Avaliação profissional para identificar problemas e propor soluções.', '[\"Diagnóstico de problemas\", \"Orçamento detalhado\", \"Recomendações técnicas\"]', '2025-04-23 22:07:03', NULL),
(5, 'Câmara Frigorífica', 'snowflake', 'Soluções para armazenamento refrigerado comercial e industrial.', '[\"Instalação de câmaras frigoríficas\", \"Manutenção de sistemas de refrigeração\", \"Projetos personalizados\"]', '2025-04-23 22:07:03', NULL),
(6, 'Projetos', 'file-text', 'Desenvolvimento de projetos de climatização para diversos ambientes.', '[\"Projetos para residências\", \"Projetos para comércios\", \"Projetos para indústrias\"]', '2025-04-23 22:07:03', NULL);
...
(3, 'Carlos', 'carlos@simaorefrigeracao.com.br', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'tecnico', NULL, '2025-04-24 23:01:53', NULL),
(5, 'Administrador', 'admin@friocerto.com.br', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', '2025-04-25 21:47:38', '0000-00-00 00:00:00', NULL);
...
ALTER TABLE `agendamentos`
  ...
  ADD CONSTRAINT `agendamentos_ibfk_3` FOREIGN KEY (`tecnico_id`) REFERENCES `  ON DELETE CASCADE,
